...
use windows_sys::Wdk::Storage::FileSystem::{
    FileRenameInformationEx, NtCreateFile, NtSetInformationFile, FILE_CREATE, FILE_DELETE_ON_CLOSE,
...
pub fn set_mode(_cap: &PlatformCap, _mode: u32) -> Result<Observation, ProtocolError> {
        ...
        primitives: PrimitiveEvidence {
            ...
            no_follow:
                "NtCreateFile(RootDirectory,FILE_OPEN_REPARSE_POINT)+FSCTL_GET/SET_REPARSE_POINT"
                    .to_string(),
            atomic_rename: "NtSetInformationFile(FileRenameInformationEx)".to_string(),
