...
async function buildPlan(context, nativeManifest, packageBootstrap, currentHelperBytes) {
	...
	// Publishing with provenance signs the tarball against the repository its
	// manifest names. The bundle ships from a subdirectory of the CLI's own
	// repository, so that pointer is generated here rather than kept in step by
	// hand in a second file.
	piManifest.repository = { ...pkg.repository, directory: "plugins/stdd" };
